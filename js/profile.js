...
try {
    ...
    $('#appointment-dashboard').append(`<div class="appointment"><p class="appointment-date" style="background:#e9e9e9; color: #3b4252ff; font-weight:bold"><img class="icon" style="background-color: white; border-radius: 30px;" src="images/appointment-booked-icon.png" height="30">New appointment</p>Your appointment will be arranged<br>with your specified doctor or any possible recommended doctors.<br><button class="cancel-appointment-button-other" onclick="location.href='./appointment.html'">Book Appointment</button></div></div>`)
} catch {
